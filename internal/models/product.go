...
type Product struct {
	...
	LaunchDate string `json:"-"` // fields which has struct tag with dash ( - ), won't be added to the resulting JSON.
}
...
// example data source - creating hard coded list of product for CRUD operations purpose.
